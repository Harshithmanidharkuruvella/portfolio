...
class App {
  ...
  createMedias(items, bend, textColor, borderRadius, font) {
    this.mediasImages = [...items, ...items]; // Duplicate for seamless infinite loop
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const galleryItems = [
    { image: "assets/gallery/01.jpg", text: "Team Success" },
    { image: "assets/gallery/02.jpg", text: "Industry Connect" },
    { image: "assets/gallery/03.jpg", text: "Award Winner" },
    { image: "assets/gallery/04.jpg", text: "Global Summit" },
    { image: "assets/gallery/05.jpg", text: "Innovator" },
    { image: "assets/gallery/06.jpg", text: "Visionary" },
    { image: "assets/gallery/07.jpg", text: "Honors" },
  ];
